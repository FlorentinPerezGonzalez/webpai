...
/**
 * @desc Función que permite obtener un color RGB aleatorio.
 * @return {String} Código RGB.
 */
...
if (typeof exports !== 'undefined') {
  ...
  exports.generalUtility.getRandomRGBColor = getRandomRGBColor;
} else { 
  ...
  window.generalUtility.getRandomRGBColor = getRandomRGBColor;
}
