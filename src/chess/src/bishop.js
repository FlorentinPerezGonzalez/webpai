 ...
 * @file Contiene la implementació de la clase Bishop, que representa
 * la pieza del alfil en el ajedrez.
 ...
 * Práctica 11. Ajedrez.
 *
 * Contenido detallado: Contiene la implementación de la clase Bishop,
 * que representa la pieza del alfil en el ajedrez. Contiene toda la información
...
class Bishop extends ChessPiece {
  /**
   * @desc Constructor de la clase Bishop.
